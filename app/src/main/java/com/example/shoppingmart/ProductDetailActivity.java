...
import com.example.shoppingmart.Adapter.MyRewardAdapter;
import com.example.shoppingmart.Adapter.ProductDetailsAdapter;
import com.example.shoppingmart.Adapter.ProductImagesAdapter;
import com.example.shoppingmart.Fragment.ProductDescriptionFragment;
import com.example.shoppingmart.Fragment.ProductSpecificationFragment;
import com.example.shoppingmart.Fragment.SignInFragment;
import com.example.shoppingmart.Fragment.SignUpFragment;
import com.example.shoppingmart.Model.ProductSpecificationnModel;
import com.example.shoppingmart.Model.RewardModel;
...
import static com.example.shoppingmart.MainActivity.showCart;
import static com.example.shoppingmart.RegisterActivity.setSignUpFragment;
...
productDetailsTabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
    ...
    public void onTabReselected(TabLayout.Tab tab) {
       ...
       buyNowBtn.setOnClickListener(new View.OnClickListener() {
        ...
        rewardModelList.add(new RewardModel("Cashback","till 2nd,jun 2019","GET 20% OFF on any product above Rs.500/- and below Rs.2500/-"));
        rewardModelList.add(new RewardModel("Discount","till 2nd,jun 2019","GET 20% OFF on any product above Rs.500/- and below Rs.2500/-"));
        rewardModelList.add(new RewardModel("Buy 1 Get 1 free","till 2nd,jun 2019","GET 20% OFF on any product above Rs.500/- and below Rs.2500/-"));
        rewardModelList.add(new RewardModel("Cashback","till 2nd,jun 2019","GET 20% OFF on any product above Rs.500/- and below Rs.2500/-"));
        rewardModelList.add(new RewardModel("Discount","till 2nd,jun 2019","GET 20% OFF on any product above Rs.500/- and below Rs.2500/-"));
        rewardModelList.add(new RewardModel("Buy 1 Get 1 free","till 2nd,jun 2019","GET 20% OFF on any product above Rs.500/- and below Rs.2500/-"));
        rewardModelList.add(new RewardModel("Cashback","till 2nd,jun 2019","GET 20% OFF on any product above Rs.500/- and below Rs.2500/-"));
