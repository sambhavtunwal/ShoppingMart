...
import com.example.shoppingmart.CategoryActivity;
...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CategoryAdapter.ViewHolder viewHolder, int position) {
        String icon = (String) categoryModelList.get(position).getCategoryIconLink();
        String name = (String) categoryModelList.get(position).getCategoryName();
